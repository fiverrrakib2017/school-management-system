...
use App\Http\Controllers\Backend\Tickets\AssignController;
    ...
    Route::prefix('admin/student')->group(function(){
        ...
        Route::prefix('examination/routine')->group(function(){
            Route::controller(ExamRoutine_controller::class)->group(function(){
                ...
                Route::get('/create','create')->name('admin.student.exam.routine.create');
                 ...
                 Route::post('/get_subject_by_exam_routine','get_subject_by_exam_routine')->name('admin.student.exam.routine.get_subject_by_exam_routine');
        ...
        Route::prefix('examination/result')->group(function(){
            Route::controller(Exam_result_controller::class)->group(function(){
                ...
                Route::post('/result_search','result_search_before_upload')->name('admin.student.search_result_before_upload');
                ...
                Route::post('/show_merit_list','show_merit_list')->name('admin.student.exam.result.show_merit_list');
            });
        });
        /** Student  Route **/
    ...
    Route::prefix('admin/settings/website/')->group(function(){
        ...
        Route::prefix('teacher_cornner')->group(function(){
            Route::controller(TeacherCornerController::class)->group(function(){
               ...
               Route::post('/update/{id}','update')->name('admin.settings.website.teacher_corner.update');
               Route::post('/store','store')->name('admin.settings.website.teacher_corner.store');
               Route::post('/delete','delete')->name('admin.settings.website.teacher_corner.delete');
            });
        });
    });
