...
@section('content')
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">All Master Ledger</span>
        </nav>
      </div><!-- br-pageheader -->
...
<div id="addModal" class="modal fade effect-scale">
        <div class="modal-dialog modal-lg modal-dialog-top mt-4" role="document">
            ...
            <div class="modal-header pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Add New Master Ledger</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
        <!----- Start Add  Form ------->
        <form action="{{route('admin.master_ledger.store')}}" method="post">
        @csrf
        ...
        <div class="modal-body ">
            ...
            <div class="col-xl-12">
                <div class="form-layout form-layout-4">
                    ...
                    <div class="row mb-4">
                        <label class="col-sm-3 form-control-label">Master Ledger Name: <span class="tx-danger">*</span></label>
...
<!----- Edit Modal ------->
  <div id="editModal" class="modal fade effect-scale">
        ...
        <!----- Start Add  Form ------->
        <form action="{{route('admin.master_ledger.update')}}" method="post">
        @csrf
