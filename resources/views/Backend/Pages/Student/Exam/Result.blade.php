          ...
          <div class="row" id="search_box">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="find_student_id"  class="form-select">
                            <option value="">---Select---</option>
                            @php
                                $data = \App\Models\Student::latest()->get();
                            @endphp
                            @if($data->isNotEmpty())
                ...
                <div class="col-md-3">
                    ...
                    <button type="button" name="submit_btn" class="btn btn-success mt-1"><i class="mdi mdi-magnify"></i> Find Exam Result</button>
                    </div>
                </div>
                {{-- <div class="col-md-1">
                    <div class="form-group mt-2">
...
<script  src="{{ asset('Backend/assets/js/custom_select.js') }}"></script>
  <script type="text/javascript">
    $(document).ready(function(){
        ...
        $("select[name='find_student_id']").select2();
