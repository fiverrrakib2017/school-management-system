...
<div class="row">
    <div class="col-md-12 ">
        <div class="card">
            <div class="card-body">
                <button data-bs-toggle="modal" data-bs-target="#examModal" type="button" class="btn-sm btn btn-success mb-2"><i class="mdi mdi-account-plus"></i>
    ...
    $('#datatable1 tbody').on('click', '.edit-btn', function () {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    $('#examForm').attr('action', "{{ route('admin.student.exam.update', ':id') }}".replace(':id', id));
                    $('#examModalLabel').html('<span class="mdi mdi-account-edit mdi-18px"></span> &nbsp;Edit Examination');
