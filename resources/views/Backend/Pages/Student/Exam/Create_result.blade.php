...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '.is_absent_checkbox', function() {
            var row = $(this).closest('tr');
            /*Is Already Checked Readonly this Row*/
            // var isChecked = $(this).is(':checked');
            // row.find('input[type="text"]').prop('readonly', isChecked);

            var written = row.find('.written_marks');
            var objective = row.find('.objective_marks');
            var practical = row.find('.practical_marks');

            if ($(this).is(':checked')) {
                written.prop('readonly', true).val('');
                objective.prop('readonly', true).val('');
                practical.prop('readonly', true).val('');
            } else {
                written.prop('readonly', false);
                objective.prop('readonly', false);
                practical.prop('readonly', false);
            }
        });
