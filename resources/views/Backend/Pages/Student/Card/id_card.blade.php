...
@section('script')
    <script type="text/javascript">
        ...
        //     var url = "{{ route('admin.student.id.card.print', ['class_id' => ':class_id']) }}";
        ...
        $("button[name='submit_btn']").on('click', function(e) {
            ...
            get_student( class_id, section_id);
        ...
        $(document).on('click', '#printBtn', function() {
            ...
            setTimeout(() => {
                ...
                if (selectedIds.length > 0) {
                    var url = "{{ route('admin.student.id.card.print', [ 'student_ids' => ':student_ids']) }}";
