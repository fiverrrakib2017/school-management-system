        ...
        <form action="{{ route('admin.student.store') }}" method="post" id="addStudentForm">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="current_class" placeholder="Enter current class" required>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="previous_class" placeholder="Enter previous class">
                </div>
                <div class="col-md-6 mb-3">
