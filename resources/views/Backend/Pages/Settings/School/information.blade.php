    ...
    <div class="col-md-7 m-auto">
        <div class="card">
            <div class="card-header bg-info text-white">
                <h3 class="card-title">School Information Settings</h3>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('admin.settings.information.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="logo" class="col-md-3 col-form-label">School Logo</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        <label for="school_name" class="col-md-3 col-form-label">School Name</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        <label for="address" class="col-md-3 col-form-label">School Address</label>
                        <div class="col-md-9">
